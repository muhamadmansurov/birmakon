			...
			<View style={styles.headerSectionBox}>
				<TouchableOpacity>
					{/* <View style={styles.headerBoxView}>
						<Text style={styles.headerBoxText}>Поддержка</Text>
					</View> */}
				</TouchableOpacity>
				<TouchableOpacity>
					<View style={styles.headerBoxView}>
						<Text style={styles.headerBoxText}>Поставщики</Text>
					</View>
				</TouchableOpacity>
				<TouchableOpacity>
					<View style={styles.headerBoxView1}>
						<Text style={styles.headerBoxText}>Товары</Text>
					</View>
				</TouchableOpacity>
			</View>
