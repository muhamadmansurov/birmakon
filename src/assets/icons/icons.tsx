...
export function PlayIcon(props: SvgProps) {
	return (
		<Svg
			...
			{...props}
		>
			<Circle cx={12.5} cy={12.5} r={12.5} fill="#EE4927" />
			<Path d="M17.5 12.5L10 16.83V8.17l7.5 4.33z" fill="#fff" />
		</Svg>
	);
}
...
export function PasswordOffIcon(props: SvgProps) {
	return (
		<Svg
			xmlns="http://www.w3.org/2000/svg"
			width={24}
...
export function BlackSearchIcon(props: SvgProps) {
	return (
		<Svg
			width={21}
			height={22}
		...
		>
			<Path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M15.005 14.02l5.604 5.604a1.05 1.05 0 11-1.486 1.485l-5.604-5.604a8.333 8.333 0 111.485-1.485h.001zm-6.588 1.147a6.25 6.25 0 100-12.5 6.25 6.25 0 000 12.5z"
				fill="#313131"
			/>
		</Svg>
	);
...
export function FiltersIcon(props: SvgProps) {
	return (
		<Svg
			width={13}
			height={14}
...
export function ChoiceIcon(props: SvgProps) {
	return (
		<Svg
			width={20}
			height={22}
...
export function Choice2Icon(props: SvgProps) {
	return (
		<Svg
			width={20}
			height={22}
...
export function ReviewIcon(props: SvgProps) {
	return (
		<Svg
			width={19}
			height={17}
		...
		>
			<Path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M17.543 11.905v3.571H1.491V1.19h9.86V0H2.18C1.166 0 .345.533.345 1.19v14.286c0 .658.821 1.19 1.834 1.19h14.676c1.013 0 1.835-.532 1.835-1.19v-3.571h-1.147zm.601-9.616L16.3.28a.842.842 0 00-1.252 0l-7.824 8.53v3.375h3.09l7.825-8.53c.34-.379.34-.986 0-1.365h.005zm-8.293 8.676H8.342V9.32l5.276-5.758 1.514 1.652-5.281 5.751zm4.554-8.262l1.515 1.651 1.268-1.383-1.514-1.65-1.269 1.382z"
				fill="#898989"
			/>
		</Svg>
	);
}
export function ReturnsIcon(props: SvgProps) {
	return (
		<Svg
			width={12}
			height={13}
...
export function BlueBackIcon(props: SvgProps) {
	return (
		<Svg
			...
			{...props}
		>
			<Path d="M1.5 1l5 5-5 5" stroke="#0052FF" strokeWidth={2} />
		</Svg>
	);
}
export function RatingsIcon(props: SvgProps) {
	return (
		<Svg
			width={40}
			height={30}
			...
			{...props}
		>
			<Rect width={40} height={30} rx={8} fill="#EE4927" />
			<Path
				d="M18.884 16.936h-1.596V19h-1.164v-2.064h-4.668v-.84l4.296-5.496h1.296l-4.116 5.304h3.228V14.08h1.128v1.824h1.596v1.032zm1.746 2.136a.807.807 0 01-.576-.228.814.814 0 01-.24-.6.76.76 0 01.24-.576c.16-.16.352-.24.576-.24.224 0 .412.076.564.228a.796.796 0 01.228.588c0 .24-.08.44-.24.6a.752.752 0 01-.552.228zm5.26-4.944c.824.08 1.452.336 1.884.768.432.424.648.968.648 1.632 0 .48-.12.916-.36 1.308-.24.384-.6.692-1.08.924-.472.224-1.052.336-1.74.336-.6 0-1.176-.088-1.728-.264-.552-.184-1.004-.436-1.356-.756l.552-.948c.288.272.656.492 1.104.66.448.16.924.24 1.428.24.624 0 1.108-.132 1.452-.396.352-.264.528-.628.528-1.092 0-.464-.172-.824-.516-1.08-.344-.256-.864-.384-1.56-.384h-.672v-.84l2.112-2.592h-4.044V10.6h5.544v.816l-2.196 2.712z"
				fill="#fff"
			/>
		</Svg>
	);
}
export function SendingsIcon(props: SvgProps) {
	return (
		<Svg
			width={15}
			height={15}
		...
		>
			<Path
				d="M8.563 6.438l5.312-5.313M10.333 1.125h3.542v3.542M13.875 8.917v3.541a1.417 1.417 0 01-1.417 1.417H2.542a1.417 1.417 0 01-1.417-1.417V2.542a1.417 1.417 0 011.417-1.417h3.541"
				stroke="#EE4927"
				strokeWidth={2}
				strokeLinecap="round"
				strokeLinejoin="round"
...
export function LocationBlueIcon(props: SvgProps) {
	return (
		<Svg
			width={18}
			height={18}
...
export function ScrollViewIcon(props: SvgProps) {
	return (
		...
		>
			<Path
				d="M1.41 0L0 1.41 4.58 6 0 10.59 1.41 12l6-6-6-6z"
				fill="#434343"
			/>
		</Svg>
	);
}
export function WhiteHeartIcon(props: SvgProps) {
	return (
		<Svg
			width={30}
			height={30}
		...
		>
			<Path
				d="M12.15 23.625c-.726-.644-1.546-1.313-2.413-2.025h-.011C6.67 19.102 3.21 16.276 1.68 12.89A8.356 8.356 0 01.9 9.45a6.064 6.064 0 016.187-6.075 6.928 6.928 0 013.745 1.106 6.3 6.3 0 011.318 1.144c.387-.439.83-.824 1.32-1.144a6.92 6.92 0 013.742-1.106A6.063 6.063 0 0123.4 9.45a8.35 8.35 0 01-.78 3.446c-1.53 3.386-4.99 6.21-8.045 8.704l-.01.009a71.513 71.513 0 00-2.414 2.025l-.001-.01zm-5.063-18A3.977 3.977 0 004.275 6.74 3.76 3.76 0 003.15 9.45c.012.866.21 1.721.576 2.506a13.854 13.854 0 002.877 3.906c1.114 1.125 2.397 2.214 3.506 3.13.307.253.62.509.933.764l.197.16c.3.246.61.5.911.75l.015-.013.006-.006h.007l.01-.008h.011l.02-.017.047-.037.008-.007.012-.009h.007l.01-.009.747-.613.196-.16c.316-.258.629-.514.936-.767 1.109-.915 2.393-2.003 3.507-3.134a13.833 13.833 0 002.877-3.905 6.122 6.122 0 00.585-2.531 3.759 3.759 0 00-1.126-2.7 3.977 3.977 0 00-2.813-1.125A4.486 4.486 0 0013.85 7.1L12.15 9.057 10.451 7.1a4.486 4.486 0 00-3.364-1.475z"
				fill="#F8F8FA"
			/>
		</Svg>
	);
